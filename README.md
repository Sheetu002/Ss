...
<body>
    ...
    <section id="education">
        <div class="section-content">
            <h2>Education</h2>
            <p>Jawaharlal nehru collegeforwomen- BCA</p>
            <h2>Education</h2>
            <p>Jawaharlal Nehru - BCA</p>
        </div>
    </section>
    ...
    <section id="resume">
        ...
        <div class="section-content">
            <center>
            <h2>Resume</h2>
            <a href="./shital shivanand (1).pdf" target="_blank" class="download-button">Download CV</a>
        </center>
        </div>
    ...
    <footer>
        <p>&copy; 2023 SHITAL SHIVANAND</p>
    </footer>
